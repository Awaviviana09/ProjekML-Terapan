...
# Ganti 'Quality' dengan nama kolom target Anda
...
# Melakukan skaling pada data menggunakan StandardScaler
scaler = StandardScaler()
...
# Evaluasi Algoritma untuk Kasus Regresi

Pada tahap ini, kita akan menggunakan enam algoritma untuk kasus regresi ini. Setelah itu, kita akan mengevaluasi performa masing-masing algoritma dan menentukan mana yang memberikan hasil prediksi terbaik. Berikut adalah keenam algoritma yang akan kita gunakan:
...
- **Kelebihan:**
  ...
  - Cocok untuk pemula.
- **Kekurangan:**
  - Rentan terhadap bias saat menghadapi banyak fitur.

---

## 2. Random Forest
- **Kelebihan:**
  - Mengurangi risiko overfitting dengan teknik bagging.
  - Memproses beberapa pohon keputusan secara bersamaan.
- **Kekurangan:**
  - Lebih kompleks dan memerlukan waktu serta daya komputasi yang lebih tinggi.

---

## 3. XGBoost
- **Kelebihan:**
  - Menggunakan teknik boosting untuk meningkatkan akurasi secara berurutan.
  - Sangat efisien untuk dataset besar.
- **Kekurangan:**
  - Waktu pelatihan lebih lama dan sensitif terhadap data berisik serta outliers.

---

## 4. Support Vector Machine (SVM)
- **Kelebihan:**
  - Efektif dalam memisahkan kelas dengan mencari hyperplane optimal.
- **Kekurangan:**
  - Pelatihan bisa memakan waktu dan memilih parameter kernel yang tepat bisa sulit.
...
- **Kekurangan:**
  - Asumsi independensi antar fitur sering kali tidak terpenuhi, yang dapat memengaruhi akurasi.

---

## 6. Decision Tree
- **Kelebihan:**
  - Mudah dipahami dan bisa menangani berbagai tipe data.
- **Kekurangan:**
  - Rentan terhadap overfitting jika pohon terlalu dalam.

---

Setelah penjelasan ini, kita akan melanjutkan dengan evaluasi performa dari masing-masing algoritma untuk menentukan yang terbaik.
"""
